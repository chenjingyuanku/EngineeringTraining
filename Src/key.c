...
uint8_t read_key_up() { return HAL_GPIO_ReadPin(key_up_GPIO_Port, key_up_Pin); }
...
void key_add_click(void *btn) {
  ...
  case pid_page:
    ...
    case 4:
      ...
      break;
    case 5:
      control.right_wheel_speed_offset += 2;
      break;
    }
    break;
  case baffle_page:
  ...
  case uphill_page:
    ...
    break;
  case get_goods_time_page:
    get_goods_time[action_speed_mode][control.item_index] += 50;
    break;
  case lift_goods_time_page:
    lift_goods_time[action_speed_mode][control.item_index] += 50;
    break;
  case place_goods_time_page:
    place_goods_time[action_speed_mode][control.item_index] += 50;
    break;
  case get_and_lift_goods_time_page:
...
void key_sub_click(void *btn) {
  ...
  case uphill_page:
    ...
    break;
  case get_goods_time_page:
    if (get_goods_time[action_speed_mode][control.item_index] >= 1050)
      get_goods_time[action_speed_mode][control.item_index] -= 50;
    break;
  case lift_goods_time_page:
    if (lift_goods_time[action_speed_mode][control.item_index] >= 1050)
      lift_goods_time[action_speed_mode][control.item_index] -= 50;
    break;
  case place_goods_time_page:
    if (place_goods_time[action_speed_mode][control.item_index] >= 1050)
      place_goods_time[action_speed_mode][control.item_index] -= 50;
    break;
  case get_and_lift_goods_time_page:
